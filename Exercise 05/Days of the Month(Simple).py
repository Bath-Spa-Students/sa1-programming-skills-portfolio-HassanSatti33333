...
if 1 <= month_number <= 12:                                                                           ## Making sure month number is valid 
    print(f"The number of days in month {month_number} is {month_days[month_number]}")                ## If Month number is valid prints the number of days in that month
else:
    print("Invalid month number! Please enter a number between 1 and 12.")                            ## If Month number is invalid prints an error message