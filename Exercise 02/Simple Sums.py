...
Int_1 = 8                                                            # Declaring a variable with value 8 
Int_2 = 10                                                           # Declaring a variable with value 10 
total = Int_1 + Int_2                                                # Declaring a variable which stores the sum of the first 2 variables

print ( f"The sum of {Int_1} and {Int_2} is {total}")                # Printing the sum of the 2 variables by calling the 3rd variable
